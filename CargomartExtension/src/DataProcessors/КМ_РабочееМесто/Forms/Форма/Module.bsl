...
Функция ТестироватьПодключение(Организация)
	...
	Если НастройкиКаргомарт = Неопределено Тогда
		...
		НастройкиКаргомарт = НастройкиКаргомартНаСервере(Организация);
...
&НаСервере
Функция НастройкиКаргомартНаСервере(Организация)
	Возврат КМ_ОбщийМодульПовтИсп.МодульЯдро().ПолучитьНастройкиКаргомарт(Организация);
КонецФункции
