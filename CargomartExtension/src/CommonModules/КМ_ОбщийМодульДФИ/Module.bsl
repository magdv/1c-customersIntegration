...
// Создание описания типа ПланСчетовБП
//
// Параметры:
//  ИмяПланаСчетов - Строка - Имя палана счетов в дереве метаданных
//
Функция ОписаниеТипаПланСчетов(ИмяПланаСчетов) Экспорт
	
	Возврат Новый ОписаниеТипов("ПланСчетовСсылка." + ИмяПланаСчетов);	
